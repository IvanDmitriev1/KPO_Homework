...
internal class AnimalCreator<T> : IAnimalCreator
    where T : Animal
{
    public AnimalCreator(IInventoryNumberProvider numbersProvider)
    {
    ...
    public Animal Create()
    {
        ...
        AnimalCreateOptions options = new AnimalCreateOptions()
        {
            Name = name,
            FoodKgPerDay = food,
            HealthPercent = hp,
